...
> *Now that we can see our state, let's change our code to allow the user to change it. Let's start with a simple pre-made action...adding one to our total.*
...
- [ ] There is a version of the calculator focuses on adding individual digits, rather then entire numbers. How do you imagine add an individual digit to the total state?
